...
extension CategorizedViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let product = CategorizedViewController.filteredProductList[indexPath.row]
        cell.productNameLabel.text = product.title
        cell.productDescriptionLabel.text = product.description
        cell.productRateLabel.text = "⭐️ \(product.rate!) "
        cell.productPriceLabel.text = "\(product.price!)$"
        cell.productImageView.sd_setImage(with: URL(string: product.image!), placeholderImage: UIImage(systemName: "photo"))
        return cell
    }
}
